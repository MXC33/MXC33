...
**AI Engineer · Fullstack Developer · Co-Founder** — Stockholm, Sweden

I build AI products end to end, from system architecture to shipped app. Most recently a real-time voice AI app, now live on Google Play.

> Most of my code lives in private company repos ([EV3 Labs](https://evidence3.com) and client orgs), so my contribution graph shows the activity but not the source. Happy to walk you through any of it on a call.
...
| **VILJA** · [EV3 Labs](https://evidence3.com) | Backend & AI engineer: built everything except the frontend. Identity voice synthesis for nonverbal communication: family voice cloning plus Voice Design shaping, emotion-to-voice mapping, an audio preprocessing pipeline, and a provider layer I migrated from Fish Audio to ElevenLabs. | TanStack Start, TypeScript, Supabase, ElevenLabs | [vilja.evidence3.com](https://vilja.evidence3.com/) |
| **EV3 Stamp** · [EV3 Labs](https://evidence3.com) | Backend engineer: built everything except the frontend. Verifiable digital identities for products: a C2PA worker that injects manifests and perceptual fingerprints, Hedera ledger anchoring, and a drop-to-verify portal backend. | FastAPI, Cloud Run, c2pa-python, Supabase (Postgres + RLS), Hedera | [Website](https://ev3stamp.lovable.app/) |
...
**Mobile:** React Native · Expo (EAS) · Android · iOS · AVAudioEngine
**Frontend:** React 19 · Next.js · Nuxt 3 · Vite · Tailwind CSS
**Backend:** FastAPI · NestJS · WebSockets · Firebase · Supabase · GCP Cloud Run · Docker
**AI:** Gemini Live · prompt architecture · RAG & query routing · local LLMs
**Web3 / identity:** World ID (ZKP) · MiniKit · Privy · Viem · Hedera · XRPL

## Contact

m.cidledezma@gmail.com · [LinkedIn](https://www.linkedin.com/in/maxcid) · Stockholm · Spanish / Swedish / English
